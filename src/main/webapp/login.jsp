...
<main role="main" class="container">
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <h4 class="text-center mb-4 mt-1">Sing in</h4>
        <hr>
        ...
        <form action="login" method="POST">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block blue">Sing in</button>
            </div>
            <p class="text-center"><a href="register.jsp" class="btn">Sing up</a></p>
        </form>
    </div>
</main>
</body>
